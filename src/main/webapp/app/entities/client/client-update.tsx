        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              />
              <ValidatedField
                label={translate('coopcycleApp.client.password')}
                id="client-password"
                name="password"
                data-cy="password"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('coopcycleApp.client.phone')}
                id="client-phone"
                name="phone"
                data-cy="phone"
                type="text"
              ...
              <ValidatedField
                ...
                type="text"
              />
              <ValidatedField label={translate('coopcycleApp.client.city')} id="client-city" name="city" data-cy="city" type="text" />
              <ValidatedField
                label={translate('coopcycleApp.client.country')}
                id="client-country"
                name="country"
                data-cy="country"
                type="text"
              />
              <ValidatedField id="client-coop" name="coop" data-cy="coop" label={translate('coopcycleApp.client.coop')} type="select">
                <option value="" key="0" />
                {cooperativelocals
