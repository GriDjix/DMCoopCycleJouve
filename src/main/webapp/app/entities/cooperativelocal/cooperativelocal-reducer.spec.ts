...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COOPERATIVELOCAL_LIST actions', async () => {
    ...
    it('dispatches FETCH_COOPERATIVELOCAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COOPERATIVELOCAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COOPERATIVELOCAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COOPERATIVELOCAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COOPERATIVELOCAL actions', async () => {
      const expectedActions = [
        {
