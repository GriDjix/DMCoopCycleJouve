...
class OrderResourceIT {
    ...
    private static final ZonedDateTime DEFAULT_DELIVERY_TIME = ZonedDateTime.ofInstant(Instant.ofEpochMilli(0L), ZoneOffset.UTC);
    private static final ZonedDateTime UPDATED_DELIVERY_TIME = ZonedDateTime.now(ZoneId.systemDefault()).withNano(0);
    ...
    @Test
    @Transactional
    void checkDeliveryCityIsRequired() throws Exception {
        int databaseSizeBeforeTest = orderRepository.findAll().size();
        // set the field null
    ...
    @Test
    @Transactional
    void checkDeliveryCountryIsRequired() throws Exception {
        int databaseSizeBeforeTest = orderRepository.findAll().size();
        // set the field null
        order.setDeliveryCountry(null);
    ...
    void getAllOrders() throws Exception {
        ...
        restOrderMockMvc
            ...
            .andExpect(jsonPath("$.[*].deliveryTime").value(hasItem(sameInstant(DEFAULT_DELIVERY_TIME))));
    }
    ...
    void getOrder() throws Exception {
        ...
        restOrderMockMvc
            ...
            .andExpect(jsonPath("$.deliveryTime").value(sameInstant(DEFAULT_DELIVERY_TIME)));
    }
