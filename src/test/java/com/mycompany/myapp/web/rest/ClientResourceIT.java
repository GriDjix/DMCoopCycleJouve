...
class ClientResourceIT {
    ...
    private static final String DEFAULT_EMAIL = "2Htl@IjV.TLRT";
    private static final String UPDATED_EMAIL = "bS@uPJ.uX";

    private static final String DEFAULT_PASSWORD = "AAAAAAAAAA";
    private static final String UPDATED_PASSWORD = "BBBBBBBBBB";

    private static final String DEFAULT_PHONE = "+196 (3277579688";
    private static final String UPDATED_PHONE = "+4 (393-2525956";
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.email(UPDATED_EMAIL).phone(UPDATED_PHONE).city(UPDATED_CITY).country(UPDATED_COUNTRY);
